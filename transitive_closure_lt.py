...
living_things_set = set(nouns[nouns.id2 == 'living_thing.n.01'].id1.unique())
living_things_set.add('living_thing.n.01')
...
print("living things list is:", living_things[0:10])
...
living_things.to_csv('living_things_closure.csv', index=False)
